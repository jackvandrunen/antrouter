...
when isMainModule:
  ...
  let Line1StopE = Stop(station: E, time: BusTime(hour: 13, minute: 25))
  ...
  let Line1 = Line(name: "Line 1", stations: [A, B, C, E].toSet(), stops: @[Line1StopA, Line1StopB, Line1StopC, Line1StopE])
